...
//Método de Conexão//
  ...
  public Conexao() {
      try {
          ...
          connection = DriverManager.getConnection("jdbc:mysql://localhost" + "/varandas_auto?useTimezone=true&serverTimezone=UTC", "root", "");
  ...
  public void close() {
      try {
          ...
          // Lidar com exceções de fechamento de conexão aqui
          e.printStackTrace();
      }
  }
